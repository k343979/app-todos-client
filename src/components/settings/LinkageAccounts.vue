<template>
    <v-card class="card-shadow border-radius-xl mt-6" id="linkage-accounts">
        <div class="px-6 py-6">
        ...
        <div class="px-6 pb-6 pt-4">
            <div class="d-flex align-center">
                ...
                <p class="mb-0 text-body text-sm font-weight-light ms-auto" v-if="switch1 == true">
                    Enabled
                </p>
                <p class="mb-0 text-body text-sm font-weight-light ms-auto" v-if="switch1 == false">
                    Disabled
                </p>
            ...
            <div class="ps-12 pt-5 ms-4">
                ...
                <div class="d-flex bg-gray-100 border-radius-lg pa-2 my-6">
                    ...
                    <div class="pa-2 border border-radius-md text-xs text-body bg-white w-25">
                        1172913
                    </div>
                </div>
                <div class="d-flex bg-gray-100 border-radius-lg pa-2 my-6 overflow-scroll">
