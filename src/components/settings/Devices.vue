<template>
    <v-card class="card-shadow border-radius-xl" id="devices">
        <div class="px-6 py-6">
            <h5 class="text-h5 font-weight-bold text-typo">Devices</h5>
            ...
            <div v-for="(item, i) in devices" :key="item.title">
                <div class="d-flex align-center ms-0">
                    ...
                    <div class="my-auto ms-4">
                        <div class="h-100">
                            <p class="text-sm mb-1 text-body font-weight-light" :v-if="item.title">
                                {{ item.title }}
                            </p>
                            <p class="mb-0 text-xs text-body font-weight-light" :v-if="item.description">
                                {{ item.description }}
                            </p>
                    ...
                    <p class="text-secondary font-weight-light text-sm my-auto me-4"
                ...
                <hr class="horizontal dark my-4" v-if="i != devices.length - 1" />
            </div>
        </div>
    </v-card>
</template>
