    ...
    <v-app>
        ...
        <v-main>
            ...
            <v-container fluid>
                ...
                <v-card class="shadow px-4 py-4 mx-9 overflow-hidden border-radius-xl mt-n16">
                    <v-row>
                        <v-col cols="auto">
                        ...
                        <v-col cols="auto" class="my-auto">
                            <div class="h-100">
                                <h5 class="mb-1 text-h5 text-typo font-weight-bold">{{ loginUser.lastName + " " + loginUser.firstName }}</h5>
                                <p v-if="loginUser.jobTitle" class="mb-0 font-weight-light text-body text-sm">{{ loginUser.jobTitle }}</p>
                            </div>
                        </v-col>
                        <!-- <v-col
                            lg="4"
