            ...
            <v-col cols="12">
                <v-card class="card-shadow border-radius-xl">
                    ...
                    <div class="card-header-padding">
                        <table-title :title="'Archives'" :description="''"></table-title>
                    </div>
                        ...
                        <v-data-table
                            ...
                            <template v-slot:[`item.actions`]="{ item }">
                                ...
                                <v-btn
                                    ...
                                    class="btn-ls me-2 my-2 rounded-sm"
                                    color="#67748e">
                                    <v-icon size="14" class="material-icons-round">delete</v-icon>
                                </v-btn>
                            </template>
                        </v-data-table>
                    </v-card-text>
...
export default {
    ...
    computed: {
        ...
        archives() {
            return this.$store.getters['tasks/archives'];
        }
    },
    methods: {
        editItem(item) {
        ...
        deleteItemConfirm() {
            this.archives.splice(this.editedIndex, 1);
        ...
        save(task) {
            if (this.editedIndex > -1) {
                ...
                this.$store.commit('tasks/updateArchive', params);
            } else {
                const id = this.archives.length + 1;
                task.id = id;
